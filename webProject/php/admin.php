...
<div class="container" style = text-align:center>
        <h2><style=font-size:30pt>교육신청란</h2>
		<img src="../images/커피교육.jpg" alt = "커피교육">
        <p>커피를 배우고픈 당신 <br> <br>자유롭게 글을 남겨주세요 <br> 연락처와 배우고픈 것을 함께 남겨주시면 더욱 좋습니다<br><br>
...
<div class="container">
            ...
            <div class="link-zone">
                ...
                <button style = "float:left;"><a href='./index.php' class="btn btn-outline-secondary btn-sm right" id="btn-write">원래대로</a></button>
            </div>
                ...
                <?php
                    ...
                    foreach( $stmt->fetchAll(PDO::FETCH_ASSOC) as $row ) {
                       ...
                       /* if ((bool) $secure) {
                        ...
                        $subject_link = "<a href='viewAdmin.php?page=".$page."&id=".$uid."&mode=view'>".$subject."</a>";
